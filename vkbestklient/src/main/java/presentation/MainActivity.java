...
import repository.database.SqlConnector;
import repository.database.domainmodel.UserDbModel;
import repository.database.util.DbConstants;
import com.github.alexvishneuski.vkbestclient.datamodel.DomainTest;
import interactor.IDialogInteractor;
import interactor.InteractorTest;
import interactor.impl.DialogInteractorImpl;
import presentation.view.activities.RecyclerViewDialogListActivity;
import presentation.view.activities.study.StudyBasedListViewWithArrayAdapterDialogsActivity;
import presentation.view.activities.study.StudyBasedListViewWithArrayListDialogsActivity;
import presentation.view.activities.study.StudyBasedListViewWithBaseAdapterDialogsActivity;
